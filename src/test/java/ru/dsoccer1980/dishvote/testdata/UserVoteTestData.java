...
public class UserVoteTestData {
    ...
    public static final UserVote USER_VOTE1 = new UserVote(USER_VOTE_ID1, USER1, RESTAURANT1, TEST_DATE);
    public static final UserVote USER_VOTE2 = new UserVote(USER_VOTE_ID2, USER2, RESTAURANT2, TEST_DATE);
    public static final UserVote USER_VOTE3 = new UserVote(USER_VOTE_ID3, USER2, RESTAURANT2, TEST_DATE);
